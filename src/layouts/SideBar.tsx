import { ChevronDown, ChevronUp, Clapperboard, Clock, Divide, Film, Flame, Gamepad2, History, Home, icons, Library, Lightbulb, ListVideo, Music2, Newspaper, PlaySquare, Podcast, Radio, Repeat, Shirt, ShoppingBag, Trophy } from "lucide-react";
...
export function SideBar () {
    ...
    <aside className="w-56 lg:sticky absolute top-0 overflow-y-auto scrollbar-hidden pb-4  flex-col gap-2 px-2 flex">
        <LargeSidebarSection>
            ...
            <LargeSidebarItem isActive IconOrImgUrl={Clapperboard} title="Subscriptions" url="/subscription"/>
        </LargeSidebarSection>
        <hr />
        ...
        <hr />
        <LargeSidebarSection title="Suscriptions">
...
function SmallSidebarItem ({ IconOrImgUrl , title , url}:
    ...
    function LargeSidebarItem({ IconOrImgUrl , title , url , isActive = false}:LargeSidebarItemProps) {
        return <a href={url} className={twMerge(buttonStyles({
