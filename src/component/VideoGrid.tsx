...
import { formatData } from "../utlis/format";
import { formatTimeAgo } from "../utlis/formatTimeAgo";
  ...
  if(isVideoPlaying) {
    ...
    return (
        ...
        onMouseLeave={() => setIsVideoPlaying(false)}>
            ...
            />
            <div className="absolute bottom-1 right-1 bg-secondary-dark text-secondary-default text-sm px-0.5 rounded">
            {formatData(duration)}
            </div>
